...
namespace FlowLearningPlatform.Migrations
{
    ...
    [Migration("20230803102950_UpdateAssignment")]
            ...
            modelBuilder.Entity("FlowLearningPlatform.Models.Enum.FilePurposeType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FilePurposeTypeId = new Guid("46c5d65e-3088-480a-a417-240873f2b62b"),
                            Name = "作业发布"
                        },
                        new
                        {
                            FilePurposeTypeId = new Guid("e9a019a2-57a6-447d-b568-b9e29e6cc2fa"),
                            Name = "作业提交"
                        },
                        new
                        {
                            FilePurposeTypeId = new Guid("494c1403-cf4e-487a-8a6f-d0c5dc82e239"),
                            Name = "公告发布"
                        });
                });
